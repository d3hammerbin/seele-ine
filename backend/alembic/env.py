...
def get_database_url():
    ...
    db_user = os.getenv('POSTGRES_USER', 'seele_user')
    db_password = os.getenv('POSTGRES_PASSWORD', 'seele_secure_password_2024')
    
    # Use synchronous postgresql driver for Alembic (not asyncpg)
